...
export const FIELD_BASIC_TYPES = [FIELD_TYPE_STRING, FIELD_TYPE_URL, FIELD_TYPE_TEXT, FIELD_TYPE_IMAGE];
export const FIELD_TYPES = [FIELD_TYPE_STRING, FIELD_TYPE_TEXT, FIELD_TYPE_IMAGE, FIELD_TYPE_ITEMS];
