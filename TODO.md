...
* [ ] Тултипы от medium болтаются во view-режиме у
    http://redshell.aydamaster.ru/fittest
* [ ] Откуда-то в базу попадает data от LeaderBoard
* [ ] Удаление или добавление кнопки криво отображается в редакторе
